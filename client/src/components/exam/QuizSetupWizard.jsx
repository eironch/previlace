...
function QuizSetupWizard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-200 py-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none disabled:bg-gray-200"
                />
                {setupConfig.mode === "mock" && (
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    disabled={setupConfig.mode === "mock"}
                    className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 focus:outline-none disabled:bg-gray-200"
                  />
                  <div className="flex items-center rounded-lg bg-gray-200 px-3">
