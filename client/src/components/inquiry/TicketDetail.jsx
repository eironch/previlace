            ...
            <div className="mb-2 flex gap-4">
              <button
                ...
                className={`text-sm font-medium ${
                  activeTab === "reply" ? "text-black" : "text-gray-500 hover:text-gray-700"
                }`}
              >
                Reply to Student
              </button>
              <button
                ...
                className={`flex items-center gap-1 text-sm font-medium ${
                  activeTab === "note" ? "text-yellow-700" : "text-gray-500 hover:text-gray-700"
                }`}
              >
            ...
            <div className={`relative rounded-lg border bg-white shadow-sm ${
              ...
              <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50 px-3 py-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 rounded-md px-4 py-1.5 text-sm font-semibold text-white transition-colors ${
                    activeTab === "note" 
